...
/**
 * Gestionnaire des préférences non sensibles de l'application.
 */
public final class AppPrefs {
    ...
    private AppPrefs() {} // Empêche l'instanciation
    ...
    public static boolean save(Context context, String name, String lang, String theme, boolean sync) {
        ...
        // Choix entre sauvegarde asynchrone (recommandée) ou synchrone
        if (sync) {
    ...
    public static Triple load(Context context) {
        SharedPreferences prefs = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        // Valeurs par défaut sécurisées si la clé n'existe pas
    ...
    // Conteneur de données simple pour renvoyer les 3 valeurs d'un coup
